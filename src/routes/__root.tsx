...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "English Up PRO" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "English Up PRO — Inglês e Espanhol para brasileiros" },
      {
        name: "description",
        content:
          "Pratique inglês e espanhol com correção de IA em português. Exercícios personalizados por nível para brasileiros.",
      },
      { property: "og:title", content: "English Up PRO — Inglês e Espanhol para brasileiros" },
      {
        property: "og:description",
        content:
          "Pratique inglês e espanhol com correção de IA em português. Exercícios personalizados por nível.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "English Up PRO — Inglês e Espanhol para brasileiros" },
