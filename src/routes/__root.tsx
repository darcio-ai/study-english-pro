...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "EnglishUp" },
      { name: "mobile-web-app-capable", content: "yes" },
      { title: "EnglishUp — Inglês para brasileiros" },
      {
        name: "description",
        content:
          "Pratique inglês com correção de IA em português. Exercícios personalizados por nível para brasileiros.",
      },
      { property: "og:title", content: "EnglishUp — Inglês para brasileiros" },
      {
        property: "og:description",
        content:
          "Pratique inglês com correção de IA em português. Exercícios personalizados por nível.",
      },
